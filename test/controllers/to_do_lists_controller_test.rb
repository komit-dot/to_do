...
class ToDoListsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create to_do_list" do
    assert_difference('ToDoList.count') do
      post to_do_lists_url, params: { to_do_list: { description: @to_do_list.description, text: @to_do_list.text, title: @to_do_list.title } }
    end
  ...
  test "should update to_do_list" do
    patch to_do_list_url(@to_do_list), params: { to_do_list: { description: @to_do_list.description, text: @to_do_list.text, title: @to_do_list.title } }
